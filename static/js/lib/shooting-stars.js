(function() {
  ...
  window.ShootingStar = function(id) {
    this.n = 0;
    this.m = 0;
    this.defaultOptions = {
      velocity: 8,
  ...
  window.ShootingStar.prototype.addBeamPart = function(x, y) {
    this.n++;
  ...
  window.ShootingStar.prototype.delTrozoHaz = function() {
    this.m++;
    $('#haz' + this.m).animate({
      opacity: 0
    }, 75);
  ...
  window.ShootingStar.prototype.getRandom = function(max, min) {
    return Math.floor(Math.random() * (max - min + 1)) + min;
  };

  window.ShootingStar.prototype.toType = function(obj) {
  ...
  window.ShootingStar.prototype.launchStar = function(options) {
  ...
  window.ShootingStar.prototype.launch = function(everyTime) {
